...
const quoteArray = [
  ...
  `Just a pipe of Pringles will suffice.`,
  `Dan\n\nDAAAAAAAAN\nDAAAAAAAAAAAAAAAAAAAAAAAAAAN\nDAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAN\n\nHe can't hear me.`,
  ...
  `With my alarm set for 5, I hit snooze every ten minutes until just before 7, at which point it’s time to start the day.`,
